        ...
        <div className={`max-w-6xl mx-auto transition-all duration-1000 ${isVisible ? 'animate-slide-in-up opacity-100' : 'opacity-0'}`}>
          ...
          <h1 className="text-responsive-4xl md:text-responsive-5xl lg:text-responsive-6xl font-display font-bold mb-6 md:mb-8 leading-tight">
            ...
            <span className="block text-responsive-sm md:text-responsive-lg lg:text-responsive-xl font-light mt-2 md:mt-3 text-luxury-400 tracking-widest animate-slide-in-right">
              Tradición Japonesa, Innovación Canaria
            </span>
          </h1>
          ...
          <p className="text-responsive-sm md:text-responsive-lg lg:text-responsive-xl text-high-contrast mb-8 md:mb-12 max-w-5xl mx-auto leading-relaxed font-light spacing-responsive">
            El primer cultivo de <span className="text-gradient-zen font-semibold">wasabi auténtico</span> en España. 
            Tecnología hidropónica de precisión en las montañas de Gran Canaria, 
            honrando la <span className="text-gradient-gold font-semibold">tradición japonesa milenaria</span> con 
            <span className="text-gradient-zen font-semibold"> innovación europea sostenible</span>.
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-8 max-w-5xl mx-auto mb-12">
            {[
              { value: "18-24", japanese: "月間栽培", description: "Meses de cultivo artesanal", color: "gold", detail: "Proceso tradicional" },
              { value: "800m", japanese: "禅の高度", description: "Altitud perfecta", color: "zen", detail: "Microclima único" },
              { value: "1º", japanese: "スペイン初", description: "Pioneros en España", color: "gold", detail: "Innovación exclusiva" }
            ].map((stat, index) => (
